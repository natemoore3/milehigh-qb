...
const IndexPage = () => {
  ...
  return (
    <div>
      ...
      <div className="container bg-dark rounded-md py-4 px-4" style={{ marginTop: -65, zIndex: 10, position: 'relative' }}>
        <div className="row justify-content-between align-items-center">
          <div className="col-12 col-md-6 text-center mb-4 mb-md-0">
            <h3 className="h2 mt-0">Quarterbacks</h3>
            <img src={imgFootballPlayer} className="img-fluid" />
          </div>
          <div className="col-12 col-md-6 text-center">
            <h3 className="h2 mt-0">Wide Receivers</h3>
            <img src={imgFootballPlayer} className="img-fluid" />
          </div>
        </div>
      </div>
      <div className="container py-4 py-lg-5">
        <div className="row">
          <div className="col-12 col-md-6">
            <div className="mb-4">
              <h4 className="text-dark mb-1">Pricing:</h4>
              <div className="pl-3">
                <p className="text-dark mb-0"><b>One on One:</b> 75$/HR</p>
                <p className="text-dark mb-0"><b>Group Rate:</b> 125$/HR</p>
              </div>
            </div>
            <div className="mb-4 mb-md-0">
              <h4 className="text-dark mb-1">What to Expect</h4>
          ...
          <div className="col-12 col-md-6">
            <h4 className="text-dark mb-1">Get Started</h4>
            <form>
              <div className="form-group">
                <input type="text" className="form-control bg-dark text-white custom-input" id="firstName" placeholder="Athletes First Name" />
              </div>
              <div className="form-group">
                <input type="text" className="form-control bg-dark text-white custom-input" id="lastName" placeholder="Athletes Last Name" />
              </div>
              <div className="form-group">
                <input type="text" className="form-control bg-dark text-white custom-input" id="position" placeholder="Position" />
              </div>
              <div className="form-group">
                <input type="text" className="form-control bg-dark text-white custom-input" id="email" placeholder="Email" />
              </div>
              <div className="form-group">
                <input type="text" className="form-control bg-dark text-white custom-input" id="phone" placeholder="Phone Number" />
              </div>
